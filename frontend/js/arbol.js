var nodes = new vis.DataSet([
  ...
  { id: 5, label: "T", color: "#4ECDC4", font: { size: 16, color: "white" }, shape: "circle" },
  { id: 6, label: "F", color: "#45B7D1", font: { size: 16, color: "white" }, shape: "circle" },
  { id: 7, label: "id", color: "#A8E6CF", font: { size: 16, color: "black" }, shape: "box" },
  { id: 8, label: ")", color: "#DDA0DD", font: { size: 16, color: "black" }, shape: "box" },
]);
...
var edges = new vis.DataSet([
  ...
  { from: 2, to: 8, arrows: "to", color: { color: "#2B7CE9" }, width: 2 },
]);
